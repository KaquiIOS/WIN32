...
fun main() {
    ...
    val irosDriver: IROSDriver = IROSDriver(InitOption("01", "01", 10, "ALL"))
    ...
    * - 04 : 간편 검색
    */
    val searchOptions: List<Map<String, String>> = listOf(
//        mapOf("searchTab" to "01", "searchCategory" to "04", "gubunIdx" to "1", "sidoIdx" to "3", "juso" to "첨단로 7", "gongdamYn" to "Y"),
...
//    // 법인등기 목록 조회 테스트
//    val driver = initDriver(InitOption(
//        searchTab = "02", searchCategory = "10", refreshInterval = 10, logLevel = "ALL"
//    ))
//
...
//        if(searchOption.checkValidity()) {
//            val start = System.currentTimeMillis()
//            println(search(driver, searchOption))
//            println("take ${(System.currentTimeMillis() - start) / 1000}s")
//        } else {
//            println("SearchOption 오류")
//        }
